/*!
Legacy interface for manipulating multiple newlines in text.
Interaction with this module happens through
[`LinurgyBuilder`]. This module will be removed in the future
